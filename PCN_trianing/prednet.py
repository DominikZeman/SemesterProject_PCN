...
class Features1D(nn.Module):
    """Base feature extractor for EMG signals"""
...
class PredNetBpE(nn.Module):
    def __init__(self, num_classes=1000, cls=0, Tied = False):
        ...
        # 8-layer instead of 12 layer
        self.ics =     [    3,   64,   64,  128,  128,  256,  256,  512,  512]
        self.ocs =     [   64,   64,  128,  128,  256,  256,  512,  512,  512]
        self.maxpool = [False,False, True,False, True,False, True,False,False]
...
class PredNetBpD(nn.Module):
    def __init__(self, num_classes=10, cls=0, Tied = False):
        ...
        #self.ics = [3,  64, 64, 128, 256, 512]      # reduced from 8 to 6 layers
        #self.ocs = [64, 64, 128, 256, 512, 512]      # matching output channels
        #self.maxpool = [False, True, False, True, False, False]  # adjusted downsampling pattern
        self.cls = cls # num of time steps
        self.nlays = len(self.ics)
